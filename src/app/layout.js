          ...
          <div className="container footer-container">
            <div className="footer-content">
              <div className="footer-brand">
                ...
                <h3 className="footer-title">Hasan Damar</h3>
                <p className="footer-subtitle">"Milli Görüş davasına adanmış bir ömür"</p>
                <div className="footer-divider"></div>
                <p className="footer-desc">
                  Avrupa'daki Türk-İslam hareketinin öncülerinden, gurbetçi kimliğinin yorulmaz savunucusu Hasan Damar'ı rahmet ve minnetle anıyoruz.
                </p>
              </div>
            ...
            <div className="footer-bottom">
              <p>&copy; {new Date().getFullYear()} Hasan Damar Arşivi. Tüm hakları saklıdır.</p>
            </div>
          </div>
        </footer>
      </body>
